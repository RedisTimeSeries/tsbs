...
//func (s *RedisTimeSeriesSerializer) Serialize(p *data.Point, w io.Writer) (err error) {
//	if keysSoFar == nil {
...
//				w.Write([]byte(" "))
//				w.Write([]byte(tagValues[i].(string)))
//				w.Write([]byte(" "))
